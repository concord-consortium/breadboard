...
{
    this.template = '/sparks-content/activities/measuring-resistance/report-templates/spot-report.html';
    this.reportElem = $('#report_area');
    this.rootDir = '/sparks-content';
}

SessionReporter.prototype =
{
    readingHintPath: '/sparks-content/common/resources/hint1_colorcode.html',
    //measuringHintPath: sparks.config.root_dir + '/common/resources/MeasureResMovie/index.html',
    measuringHintPath: '/sparks-content/common/resources/hint1_dmm.html',
    toleranceHintPath: '/sparks-content/common/resources/hint1_calctolerance.html',
    ...
    getFeedbackLine: function (fb, tutorialURL) {
        var imgPath = this.rootDir + '/common/icons/spark.png';
