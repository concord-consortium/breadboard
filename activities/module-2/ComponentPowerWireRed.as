//sparks.flash.sendCommand('insert_component', 'redPowerWire', "woo", "e30, e25", "C10");
...
package {
    ...
    public class ComponentPowerWireRed extends ComponentObj {
		...
		private var _leadTilt:Number = 160 * Math.PI/180;  //extra rotation for cap/reductor leads in radions 
		
		private var _leadLength:Number;
		
	
        
        public function ComponentPowerWireRed() {
            
			super();
            graphicsLayer = MovieClip(this.getChildByName('powerWireRed_mc'));
		...
		public function dimensionRedPowerWire(x1:Number,y1:Number,x2:Number,y2:Number):void {
